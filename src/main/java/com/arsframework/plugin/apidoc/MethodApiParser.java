...
public class MethodApiParser {
    ...
    /**
     * Class document provider function
     */
    private final Function<Class<?>, ClassDoc> documentProvider;

    /**
     * Parameter class validator
     */
    private final BiFunction<java.lang.reflect.Parameter, Class<?>, Boolean> parameterValidator;

    private MethodApiParser(Method method, Function<Class<?>, ClassDoc> documentProvider,
                            BiFunction<java.lang.reflect.Parameter, Class<?>, Boolean> parameterValidator) {
        Objects.requireNonNull(method, "method not specified");
        Objects.requireNonNull(documentProvider, "documentProvider not specified");
        Objects.requireNonNull(parameterValidator, "parameterValidator not specified");
        this.method = method;
    ...
    private static boolean isRequired(java.lang.reflect.Parameter parameter) {
        ...
        return parameter != null && (isRequired((AnnotatedElement) parameter) ||
    ...
    private static String getName(Field field) {
        ...
        String name = annotation == null ? null : annotation.value().trim();
     ...
     */
    private static Parameter.Size getSize(AnnotatedElement element) {
     ...
     */
    private static String getFormat(AnnotatedElement element) {
        Objects.requireNonNull(element, "element not specified");
        String format;
     ...
     * @param documentProvider   Class document provider function
     * @param parameterValidator Parameter class validator function
     * @return Api object
     */
    public static Api parse(Method method, Function<Class<?>, ClassDoc> documentProvider,
                            BiFunction<java.lang.reflect.Parameter, Class<?>, Boolean> parameterValidator) {
        return new MethodApiParser(method, documentProvider, parameterValidator).execute();
    }
    ...
    private ClassDoc getDocument(Class<?> clazz) {
        Objects.requireNonNull(clazz, "clazz not specified");
        return this.documentProvider.apply(clazz);
    }
